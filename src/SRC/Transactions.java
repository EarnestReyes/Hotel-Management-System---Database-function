...
public class Transactions extends javax.swing.JPanel {
    ...
    public Transactions(SRC.NewJFrame frame) {
        this.frame = frame;
        initComponents();
    ...
    try {
        ...
        while (rs.next()) {
            ...
            String client_phoneNumber = rs.getString("client_phoneNumber");

            String check_in_datetime = rs.getString("check_in_datetime");
    ...
    private void initComponents() {
        ...
        add(P_suites);
        P_suites.setBounds(753, 20, 100, 30);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/Transacs.png"))); // NOI18N
        add(jLabel1);
